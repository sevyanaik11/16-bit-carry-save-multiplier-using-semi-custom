...
HD_PWD='F:/123ec0027/carrysave/carrysave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_save_multiplier_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carry_save_multiplier_4bit.tcl
